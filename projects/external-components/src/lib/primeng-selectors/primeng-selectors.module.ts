import { BeginnerSLUCKComponent } from './components/beginner's-LUCK-external/beginner's-LUCK-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, BeginnerSLUCKComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, BeginnerSLUCKComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
